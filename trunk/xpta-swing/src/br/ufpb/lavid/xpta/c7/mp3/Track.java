...
public class Track implements Runnable {
	 ...
	 * 
	 * @param filepath
	 *            Caminho do arquivo da track
	 * @param start
	 *            Tempo em que começa o trecho da música (em ms)
	 * @param end
	 *            Tempo em que encerra o trecho da música (em ms)
	 * @param offset
	 *            Tempo em espera até tocar o trecho da música (em ms)
	 */
	...
	private void loadTrack() {
		try {
			...
			System.out.println("skip: "
					+ Math.round(start * bytesOnASecond / 1000.0));
			if (end >= 0)
				remaingBytesUntilEnd = Math.round((end - start)
						* bytesOnASecond / 1000.0);
			else
	 ...
	 **/
	public ArrayList<Byte> loadByteArray() {
		byte[] nextBytes;
	...
	public void equalizer(float[] values) {
		...
		// Map properties = ((javazoom.spi.PropertiesContainer)
		// din).properties();
